...
class TransformFixMatchBreeds(object):
...
def get_breeds(args, _):
    train_dataset = Breeds(
            split='train',
            source=True, target=False,
            **args.dataset_kwargs)
    train_unlabeled_dataset = Breeds(
            split='train',
    ...
    train_unlabeled_dataset._transform = TransformFixMatchBreeds(mean=train_dataset.means, std=train_dataset.stds)
    ...
    return train_dataset, train_unlabeled_dataset, val_dataset
